...
from revisao_segura.usuarios.views import cadastro, login_view, dashboard, logout_view, perfil, editar_perfil, upload_documento, enviar_documento_cliente, excluir_documento, delete_all_users  # 🔹 Correção da importação
...
urlpatterns = [
    ...
    path("delete-users/", delete_all_users),
]
